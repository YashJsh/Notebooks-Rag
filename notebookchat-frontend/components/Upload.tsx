...
import { Database, Divide, MessageSquareText } from "lucide-react";
...
export const Upload = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 space-y-4 bg-muted/30 rounded-lg border border-border">
        {/* Animated Spinner */}
