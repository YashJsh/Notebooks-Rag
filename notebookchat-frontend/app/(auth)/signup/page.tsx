...
import { SignUpSchemaType, signUpSchema } from "@/types/auth.types";
        ...
        <Card className="w-full max-w-sm rounded-2xl border border-border/60 bg-card shadow-lg shadow-black/5">
            <CardHeader className="space-y-2 text-center pb-6">
                ...
                <CardDescription className="text-sm text-muted-foreground">
                    Start building and exploring your workspace
                </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="pt-6">
                <p className="w-full text-center text-sm text-muted-foreground">
                    ...
                    <Link href={"/signin"} className="font-medium text-foreground underline underline-offset-4 hover:opacity-80">SignIn</Link>
                </p>
            </CardFooter>
        </Card>
    );
